...
(function () {
  ...
  function load(config) {
    ...
    // 在线
    if (
      !inArray(includes, "ol-debug") &&
      !inArray(includes, "ol@4.6.5") &&
      !inArray(excludes, "ol")
    ) {
    ...
    if (inArray(includes, "ol-mapbox-style")) {
      inputScript(
        libsurl + "/openlayers/plugins/ol-mapbox-style/2.11.2-4/olms.js"
      );
    }
    ...
    if (inArray(includes, "animatedclusterlayer")) {
      inputScript(
        libsurl +
          "/openlayers/plugins/animatedclusterlayer/animatedclusterlayer.js"
      );
    }
    if (inArray(includes, "layerswitcher")) {
      inputCSS(
        libsurl +
          "/openlayers/plugins/ol-layerswitcher/3.8.3/ol-layerswitcher.css"
      );
      inputScript(
        libsurl +
          "/openlayers/plugins/ol-layerswitcher/3.8.3/ol-layerswitcher.js"
      );
    }
